...
!function($) {
    ...
    ChartJs.prototype.init = function() {
            ...
            datasets: [
                {
                    ...
                    pointRadius: 1,
                    pointHitRadius: 10,
                    data: [10.33, 10, 7, -3, 0.9, 1, 7.2, 10, 10, 30]
                }
            ]
        };
            ...
            datasets: [
                {
                    ...
                    data: [6.5, 5.9, 8.0, 8.1, 5.6, 5.5, 4.0, 20, 4.1, 35]
                }
            ]
        };
        ...
        //radar chart
        var radarChart = {
            labels: ["Activity", "Length of Investment", "Frequency", "Profit", "Diversity", "Prudence", "Amount"],
            datasets: [
                {
                    label: "Average of All Families",

...
new Chartist.Bar('#stacked-bar-chart', {
  labels: ['Q1', 'Q2', 'Q3', 'Q4'],
  series: [
    [200000, 225000, 175000, 95000],
    [140000, 125000, 135000, 40000],
    [30000, 6000, 4500, 2000]
  ]
}, {
  stackBars: true,
  axisY: {
...
new Chartist.Bar('#distributed-series', {
  labels: ['Salary', 'Investment', 'Pocket Money', 'Cash Award'],
  series: [83000, 7000, 1500, 500]
}, {
...
var data = {
  labels: ['Mr. Mark Steve', 'Mrs. Jane Steve', 'Chris Steve'],
  series: [50000, 40000, 2000]
};
